...
Non-mutating work is immediate. `inline plan` means minimal safety discovery, then the envelope without narration.
Changes/external actions get one approved plan; prefixed ops and aliases stay in Forge; controls resolve normally.
